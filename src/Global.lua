...
genData = { gen1PokemonData, gen2PokemonData, gen3PokemonData, gen4PokemonData, gen5PokemonData }
...
function enoughPokemon()
  ...
  if selectedGens[5] then
    numPokemon = numPokemon + 175
  end
  if selectedGens[6] then
    numPokemon = numPokemon + 72
  end
  if selectedGens[7] then
    numPokemon = numPokemon + 88
  end
  if selectedGens[8] then
    numPokemon = numPokemon + 96
  end
  if customGen then
    local pokeball
